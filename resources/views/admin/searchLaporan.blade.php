...
<div class="p-6">
    <div class="flex justify-between items-center mt-2">
        <h3 class="text-2xl sm:text-3xl font-semibold">Search Laporan</h3>
    </div>
                ...
                <tbody>
                    ...
                    <td class="px-4 py-2 border-t border-b text-center">{{$report->jenisLaporan}}</td>
                        ...
                        <td class="px-4 py-2 border-t border-b text-center">
                            ...
                            @else
                                <a href="{{ route('admin.processReport', $report->id) }}" class="bg-green-500 text-white px-4 py-2 rounded-md">Process</a>
                            @endif
                        </td>
                    </tr>
                    @endforeach
