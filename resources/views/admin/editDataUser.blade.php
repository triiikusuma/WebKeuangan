...
<div class="p-4 sm:p-6">
    <div class="flex justify-between items-center mt-2">
        <h3 class="text-2xl sm:text-3xl font-semibold">Edit data mahasiswa</h3>
    </div>

    <div class="bg-white p-6 rounded-lg shadow-md mt-6">
        <form action="{{ route('admin.updateDataUser', $user->id) }}" method="post" class="flex flex-col gap-3">
            @csrf
            @method('patch')
    ...
    <div class="flex justify-between items-center mt-6">
        <h3 class="text-2xl sm:text-3xl font-semibold">Edit password mahasiswa</h3>
    </div>

    <div class="bg-white p-6 rounded-lg shadow-md mt-6">
        <form action="{{ route('admin.updateUserPassword', $user->id) }}" method="post" class="flex flex-col gap-3">
            @csrf
            @method('put')
            {{-- <div class="flex flex-col">
